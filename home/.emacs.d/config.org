...
** Functions
    ...
    #+BEGIN_SRC emacs-lisp
      (defun utz/find-skhdrc (arg)
	"Open SKHD configuration file in a new window.\nUse `C-u' to open in a new frame."
	(interactive "P")
	(let ((file (expand-file-name "home/.config/skhd/skhdrc" utz-dotfiles-dir)))
	  (if arg
    ...
    #+BEGIN_SRC emacs-lisp
      (defun utz/find-yabairc (arg)
	"Open Yabai configuration file in a new window.\nUse `C-u' to open in a new frame."
	(interactive "P")
	(let ((file (expand-file-name "home/.config/yabai/yabairc" utz-dotfiles-dir)))
	  (if arg
	      (find-file-other-frame file)
	    (find-file-other-window file))))
    #+END_SRC
...
**** c - Config Files
	 ...
	 "" '(:ignore t :wk "Configuration Files")
	 "y" '(utz/find-yabairc :wk "Yabai")
	 "s" '(utz/find-skhdrc :wk "SKHD"))
     #+END_SRC
