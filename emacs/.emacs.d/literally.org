...
*** General.el
    ...
    [[https://github.com/noctuid/general.el][General.el]] is how we setup all our other keybindings.
     
    #+BEGIN_SRC emacs-lisp
      (use-package general
	:init
	(setq utz-leader-key "SPC"
	      utz-localleader-key ","
	      utz-definer-states '(normal insert emacs visual)))
    #+END_SRC
...
** Tweak the Theme
   ...
   #+BEGIN_SRC emacs-lisp
     (custom-theme-set-faces 'user
			     '(default ((t (:family "JetBrainsMono Nerd Font" :height 140))))
			     '(outline-1 ((t (:height 1.6))))
