...
# End:
* Modules
I've written some of my own modules that I'd like to share with the class.
** XDG
:PROPERTIES:
:header-args:nushell: :tangle scripts/xdg.nu
:END:
...
** Service
:PROPERTIES:
:header-args:nushell: :tangle scripts/service/mod.nu
:END:
