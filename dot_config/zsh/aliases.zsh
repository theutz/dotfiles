...
alias gpgagente="pope $HOME/.gnupg/gpg-agent.conf"
alias gpge="pope $HOME/.gnupg/gpg.conf"
...
alias skhde="pope $XDG_CONFIG_HOME/skhd/skhdrc"
...
alias twc="while :; do clear; tw day; sleep 10; done"
alias yabaie="pope $XDG_CONFIG_HOME/yabai/yabairc"
